...
def get_config():
    ...
    parser.add_argument("--experiment_name", type=str, default="many ue")
    ...
    parser.add_argument('--wandb_name', type=str, default="Mac2")

    # env parameters
    parser.add_argument('--env_name', type=str, default="Mac")
    parser.add_argument("--use_obs_instead_of_state", action='store_true',
                        default=False, help="Whether to use global state or concatenated obs")

    # replay buffer parameters
    parser.add_argument('--episode_length', type=int,
                        default=24, help="Max length for any episode")
    ...
    parser.add_argument('--num_random_episodes', type=int, default=2048,
